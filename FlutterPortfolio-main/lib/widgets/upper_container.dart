...
import 'package:portfolio/widgets/ricardosantiago_image.dart';
        ...
        if (consraints.maxWidth >= Breakpoints.lg) {
          ...
          return Column(
            ...
            children: [
              ...
              RicardoSantiagoImage(width: (2 * width) - 0.16 * width),
          ...
          return Column(
            ...
            children: [
              SizedBox(width: width * 0.07),
              Center(child: RicardoSantiagoImage(width: 2 * width)),
              SizedBox(height: 0.05 * width),
